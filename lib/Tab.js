...
export default class Tab extends Component {
  ...
  // HACK: Somehow, after the first transition from active to inactive, the
  //   icon jumps down when transitioning to the active state again. We need to
  //   store, if it already transitioned, to catch that case and manually Movies
  //   it up.
  //   Is this a bug in react-native or somewhere here? This only happens in
  //   Android, not iOS.
