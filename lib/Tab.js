...
export default class Tab extends Component {
  ...
  //   icon jumps down when transitioning to active again. This is is catch
  //   and fix that case. Only happens in Android.
  //   Is it a bug in react-native or somewhere here?
