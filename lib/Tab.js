...
export default class Tab extends Component {
  ...
  render() {
    const { icon, label, active, style} = this.props
  ...
  _renderIcon = () => {
    ...
    return (
      ...
      >
        <View ref="_bnic" collapsable={false} style={{alignItems:'center'}}>
  ...
  _renderLabel = () => {
    const { active, labelColor, activeLabelColor, label, labelStyle} = this.props
  ...
  _animateShiftingInactiveToActive = () => {
    ...
    Animated.parallel([
      ...
      Animated.timing(this.state.shifting.labelOpacity,
        { toValue: 1, duration: 0, delay: 0, easing, useNativeDriver }),
  ...
  _animateShiftingActiveToInactive = () => {
    ...
    Animated.parallel([
      ...
      Animated.timing(this.state.shifting.labelOpacity,
        { toValue: 0, duration: 0, easing, useNativeDriver }),
      Animated.timing(this.state.shifting.labelScale,
