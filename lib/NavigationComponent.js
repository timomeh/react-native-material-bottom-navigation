...
class NavigationComponent extends PureComponent<void, NCProps, void> {
  render() {
    ...
    const bnProps = {
      tabStyle: bnOptions.tabStyle || {},
      labelStyle: bnOptions.labelStyle || {},
    ...
    return (
      ...
      >
        {navigationState.routes.map((route, index) => {
          ...
          const tabProps = {
            style: tabOptions.style || bnOptions.tabStyle,
            labelStyle: tabOptions.labelStyle || bnOptions.labelStyle,
